...
def main(args):
    ...
    path_to_load = "/home/ruzickav/python_projects/ChangeDetectionProject/___ResultsPlots/Methods_test_1_Random 2/[TryingRandomOnFull2]_al_statistics.npy"
    statistics = np.load(path_to_load)
    ...
    print(
        "Trying one with 1k to 40k balance and having it run properly - for few iterations at least -> later compare that between methods")
